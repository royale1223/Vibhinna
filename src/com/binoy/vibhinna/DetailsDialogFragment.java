    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Cursor cursor = mContext.getContentResolver().query(
                Uri.parse("content://" + VibhinnaProvider.AUTHORITY + "/"
                        + VibhinnaProvider.VFS_BASE_PATH + "/details/" + id), null, null, null,
                null);
        cursor.moveToFirst();
        ...
        if (vsinfo[16] == Constants.N_A) {
            ...
            dspace.setText(getString(R.string.free_space, vsinfo[17], vsinfo[16]));
        ...
        if (vsinfo[25] == Constants.N_A) {
            ...
            sspace.setText(getString(R.string.free_space, vsinfo[25], vsinfo[24]));
