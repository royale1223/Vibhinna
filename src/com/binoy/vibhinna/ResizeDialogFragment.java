...
public class ResizeDialogFragment extends SherlockDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        cacheSizeText = (TextView) resizeView.findViewById(R.id.resize_dialog_cache_size);
        cacheSeekBar = (SeekBar) resizeView.findViewById(R.id.resize_dialog_cache_size_seekbar);

        dataSizeText = (TextView) resizeView.findViewById(R.id.resize_dialog_data_size);
        dataSeekBar = (SeekBar) resizeView.findViewById(R.id.resize_dialog_data_size_seekbar);

        systemSizeText = (TextView) resizeView.findViewById(R.id.resize_dialog_system_size);
        systemSeekBar = (SeekBar) resizeView.findViewById(R.id.resize_dialog_system_size_seekbar);
        ...
        cacheSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (progress < cacheMin) {
                    ...
                    cacheSize = cacheMin;
                    cacheSizeText.setText(getString(R.string.space_in_mb, cacheMin));
                } else {
                    cacheSize = progress;
                    cacheSizeText.setText(getString(R.string.space_in_mb, progress));
        ...
        dataSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (progress < dataMin) {
                    ...
                    dataSize = dataMin;
                    dataSizeText.setText(getString(R.string.space_in_mb, dataMin));
                } else {
                    dataSize = progress;
                    dataSizeText.setText(getString(R.string.space_in_mb, progress));
                    if (progress > previous) {
        ...
        systemSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (progress < systemMin) {
                    ...
                    systemSizeText.setText(getString(R.string.space_in_mb, systemMin));
                } else {
                    systemSize = progress;
                    systemSizeText.setText(getString(R.string.space_in_mb, progress));
                    if (progress > previous) {
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            service.putExtra(VibhinnaService.TASK_TYPE, VibhinnaService.TASK_TYPE_RESIZE_VFS);
    ...
    private void setUpMaxMin() {
        ...
        for (String image : images) {
            ...
            int freeSpaceInMb = Integer.parseInt(freeBlocks) * Integer.parseInt(blockSize)
                    / 1048576;
    ...
    private int sdFreeSpace() {
        return (int) (Environment.getExternalStorageDirectory().getUsableSpace() / 1048576);
    }
