...
public class VibhinnaActivity extends SherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(bar.newTab().setText(getString(R.string.list_tab_title)),
                VibhinnaFragment.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(getString(R.string.list_tab_tasks)),
                TasksQueueFragment.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(getString(R.string.list_tab_info)),
